...
class NoticiaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create noticium" do
    assert_difference('Noticium.count') do
      post noticia_url, params: { noticium: { bajada: @noticium.bajada, comentario_id: @noticium.comentario_id, cuerpo: @noticium.cuerpo, detalle_id: @noticium.detalle_id, titulo: @noticium.titulo } }
    end
  ...
  test "should update noticium" do
    patch noticium_url(@noticium), params: { noticium: { bajada: @noticium.bajada, comentario_id: @noticium.comentario_id, cuerpo: @noticium.cuerpo, detalle_id: @noticium.detalle_id, titulo: @noticium.titulo } }
